...
function ClientConfig(options) {
    ...
    Object.defineProperty(this, 'log', {
        value: bunyan.createLogger(Object.merge({
            name: 'cisco-kube-client', level: bunyan.FATAL || options.logLevel
    ...
    if (options.auth) {
        ...
        Object.defineProperty(this, 'auth', { writable: true, value: {
            user: trim(options.auth.user, 'auth.user')
            , pass: trim(options.auth.pass, 'auth.pass')
        }});
    } else {
