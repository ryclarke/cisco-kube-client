 ...
 * @param {string} level - Logging level for the output
 ...
 * @throws {Error}
 */
module.exports.throw = function (log, level, error, data, message, reject) {
    if (message) {
        log[level](Object.merge({err: error}, data, true), message);
    } else {
        log[level](Object.merge({err: error}, data, true));
    }
